...
https://pytorch-lightning.readthedocs.io/en/1.8.6/_modules/pytorch_lightning/callbacks/early_stopping.html#EarlyStopping.on_train_epoch_end

Add warm-up period (only start counting patience after the specified epoch)
...
class EarlyStopping(Callback):
    ...
    def load_state_dict(self, state_dict: Dict[str, Any]) -> None:
        ...
        self.warm_up = state_dict["warm_up"]
    ...
    def _run_early_stopping_check(self, trainer: "pl.Trainer") -> None:
        ...
        # if trainer.current_epoch >= self.warm_up:
